  ...
  return(
    ...
    >
      ...
      <ul className='mt-5 list-disc ml-5 space-y-2'>{experience.points.map((point, index) =>(
        <li key={`experience-point-${index}`} className='text-white-100 text-[14px] pl-1 traking-wider'>{point}</li>
      ))}
      </ul>
    </VerticalTimelineElement>
  ...
  return (
    <div className='bg-primary '>
      <motion.div variants={textVariant()} className='bg-primary'>
        ...
        <h2 className={`${styles.sectionHeadText} text-center bg-primary`}>
          Work Experience.
        </h2>
